...
#undef RtlZeroMemory
extern "C"{
	DECLSPEC_IMPORT VOID NTAPI RtlMoveMemory (LPVOID UNALIGNED Dst, LPCVOID UNALIGNED Src, SIZE_T Length);
	DECLSPEC_IMPORT VOID NTAPI RtlFillMemory (LPVOID UNALIGNED Dst, SIZE_T Length, BYTE Pattern);
	DECLSPEC_IMPORT VOID NTAPI RtlZeroMemory (LPVOID UNALIGNED Dst, SIZE_T Length);
}
